...
forvalue j=1/7 {
	...
	capture drop posses 
	plist_pisa_1 posdsk poscom posnet posdic 
	plist_pisa_2 posdsk poscom posnet posdic 
	plist_pisa_3 posdsk poscom posnet posdic 
	plist_pisa_4 posdsk poscom posnet posdic 
	plist_pisa_5 posdsk poscom posnet posdic 
	plist_pisa_6 posdsk poscom posnet posdic 
	plist_pisa_7 posdsk poscom posnet posdic 
	plist_timss_1 posdsk poscom poscal posdic 
	plist_timss_2 posdsk poscom poscal posdic 
	plist_timss_3 posdsk poscom poscal posdic 
	plist_timss_4 posdsk poscom posnet posdic 
	plist_timss_5 posdsk poscom posnet posrom 
	plist_timss_6 posdsk poscom posnet posrom
	plist_timss_7 posdsk poscom posnet posrom
