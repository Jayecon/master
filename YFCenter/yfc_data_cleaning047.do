...
use yfc, clear
    ...
    /*문자함수 청소*/
        ...
        /*lsns*/
            ...
            egen lsnsfam = rowtotal(lsns1 lsns2 lsns3)
                label var lsnsfam "사회적유대 가족"
            egen lsnsfrd = rowtotal(lsns5 lsns6 lsns7)
                label var lsnsfrd "사회적유대 친구"
            egen lsnsspt = rowtotal(lsns4 lsns8 )
        ...
        /*hq25*/
            ...
            egen hqsec = rowtotal(hq2 hq5)
                label var hqsec "물리적 은둔"
            egen hqsoc = rowtotal( hq1 fhq4 hq6 fhq8 hq11 fhq15 hq18 hq20 hq23 fhq25)
                label var hqsec "사회성"
            egen hqiso = rowtotal( hq9 hq12 hq13 hq16 hq19 fhq22 hq24)
                label var hqsec "고립"
            egen hqspt = rowtotal(hq3 hq7 fhq10 hq14 hq17 fhq21)
                label var hqsec "사회적 지지"
drop __* gf am
save , replace
/*}}}*/
