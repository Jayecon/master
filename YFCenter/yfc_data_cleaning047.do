...
use yfc, clear
    ...
    /*문자함수 청소*/
        ...
        /*a1 b1 destring*/
            ...
            destring b1 , replace
        /*lsns*/
            replace lsns1 = "1" if lsns1 == "1명"
            replace lsns1 = "2" if lsns1 == "2명"
            replace lsns1 = "3" if lsns1 == "3-4명"
            replace lsns1 = "4" if lsns1 == "5-8명"
            replace lsns1 = "5" if lsns1 == "9명이상"
            replace lsns1 = "0" if lsns1 == "없다"
            replace lsns2 = "1" if lsns2 == "1명"
            replace lsns2 = "2" if lsns2 == "2명"
            replace lsns2 = "3" if lsns2 == "3-4명"
            replace lsns2 = "4" if lsns2 == "5-8명"
            replace lsns2 = "0" if lsns2 == "없다"
            replace lsns3 = "1" if lsns3 == "1명"
            replace lsns3 = "2" if lsns3 == "2명"
            replace lsns3 = "3" if lsns3 == "3-4명"
            replace lsns3 = "4" if lsns3 == "5-8명"
            replace lsns3 = "5" if lsns3 == "9명이상"
            replace lsns3 = "0" if lsns3 == "없다"
            replace lsns4 = "1" if lsns4 == "가끔있다"
            replace lsns4 = "2" if lsns4 == "거의없다"
            replace lsns4 = "3" if lsns4 == "매우자주있다"
            replace lsns4 = "4" if lsns4 == "자주있다"
            replace lsns4 = "5" if lsns4 == "전혀없다"
            replace lsns4 = "0" if lsns4 == "항상있다"
            replace lsns5 = "1" if lsns5 == "1명"
            replace lsns5 = "2" if lsns5 == "2명"
            replace lsns5 = "3" if lsns5 == "3-4명"
            replace lsns5 = "4" if lsns5 == "5-8명"
            replace lsns5 = "5" if lsns5 == "9명이상"
            replace lsns5 = "0" if lsns5 == "없다"
            replace lsns6 = "1" if lsns6 == "1명"
            replace lsns6 = "2" if lsns6 == "2명"
            replace lsns6 = "3" if lsns6 == "3-4명"
            replace lsns6 = "4" if lsns6 == "5-8명"
            replace lsns6 = "5" if lsns6 == "9명이상"
            replace lsns6 = "0" if lsns6 == "없다"
            replace lsns7 = "1" if lsns7 == "1명"
            replace lsns7 = "2" if lsns7 == "2명"
            replace lsns7 = "3" if lsns7 == "3-4명"
            replace lsns7 = "4" if lsns7 == "5-8명"
            replace lsns7 = "5" if lsns7 == "9명이상"
            replace lsns7 = "0" if lsns7 == "없다"
            replace lsns8 = "1" if lsns8 == "가끔있다"
            replace lsns8 = "2" if lsns8 == "거의없다"
            replace lsns8 = "3" if lsns8 == "매우자주있다"
            replace lsns8 = "4" if lsns8 == "자주있다"
            replace lsns8 = "5" if lsns8 == "전혀없다"
            replace lsns8 = "0" if lsns8 == "항상있다"
            forvalue i = 1/8 {
