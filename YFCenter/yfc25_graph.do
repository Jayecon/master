...
restore , preserve
    ...
    gr bar v1 v2 v3 v4 if soc , over(tag) `mybaroptdset' saving(hq_soc_dset.gph , replace)
...
restore , preserve
    ...
    gr bar v1 v2 v3 v4 if soc , over(tag) `mybaroptdur' saving(hq_soc_dur.gph , replace)
