\documentclass[11pt,]{exam} %정답지를 만들경우 answers 옵션을 넣을 것.
%----------------------------------------------------------
% PACKAGES AND THEMES
%----------------------------------------------------------
\usepackage{kotex}
...
\question유해위험작업종사자의 근로기준시간은 1주간 \fillin[40시간]{}이다.
...
\begin{parts}
    \part[5] 올해 평균 가구소득을 7000만원이라고 가정하자. 위에 제시된 두 사람의 가구가 중산층인지 여부를 답하시오. \\[3pt]
        \ifprintanswers\relax
            \textbf{설명}: 중산층의 기준은 가구소득의 50--150\%이다. 중산층은 연간 총소득이 3,500만원-1억 500만원 사이인 가구이다. 김수현 가구는 중산층보다 소득이 높고, 김지원 가구는 중산층이다.
        \else
        ...
        \fi
    \stepcounter{part}
    \part[10] 소득분배의 관점에서 김수현과 김지원 중 누구의 가구 더 높은 소득수준을 유지하는가? 구체적인 수치로 제시하라. (단, 제곱근은 소수 첫째자리로 계산한다.)\\[3pt]
        \ifprintanswers\relax
            \textbf{설명}: 소득분배의 관점에서 비교하려면 균등화처분가능 소득으로 변환해야 한다.
            \[ 
...
\question[10] 전공의 집단사직이 사회적으로 문제가 되고 있다. 전공의 협의회에 적합한 조직형태를 제시하고 장·단점을 사례에 맞게 서술하시오.  \\[3pt]
    \ifprintanswers\relax
        \textbf{설명}: 직업별 노동조합
    \else
        \rule{\linewidth}{0.4pt} \\[3pt]
...
\question[10] 자본주의와 노사갈등간의 관계에 대하여 설명하시오. \\[3pt]
    \ifprintanswers\relax
        \textbf{설명}: 노사갈등에 대한 다원론적 입장
    \else
        \rule{\linewidth}{0.4pt} \\[3pt]
        \rule{\linewidth}{0.4pt} \\[3pt]
        \rule{\linewidth}{0.4pt} \\[3pt]
