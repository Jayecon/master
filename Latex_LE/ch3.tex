...
\begin{frame}[allowframebreaks]{이념별 노동조합의 종류}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}[<+->]
            \item 자본주의적 자유 이념보다는 사회적 합의 이념을 중시, 사회적 복지 국가를 지향 사회체제의 점진적 변혁을 기도
        ...
        \begin{itemize}[<+->]
            \item 자본주의 체제를 인정하고 시장경제체제하에서 노동조합원의 임금이나 노동조합의 개선을 가장 직접적이며 중요한 목표로 삼음 
            \item 입법을 통한 정치적인 수단보다는 단체협상 등의 순수한 경제적 수단을 중시
            \item 노동계층 전부를 위하기보다는 노동조합원들만의 경제적인 지위향상에 전력을 기울임
...
\begin{frame}[allowframebreaks]{노동조합의 주요 역할}
    \begin{enumerate}[<+->]
        ...
        \begin{itemize}[<+->]
            \item 노동조합의 존립과 발전을 위하여 신규 노조원을 조직하고 조직된 조합원을 동원·선동하여 자신들의 주장을 관철하는 역할
            \item 조합원의 다양한 요구조건을 민주적으로 수용하고 또 지속적으로 조직·관리·동원하여 노동조합의 영향력을 유지하여야 함
        \end{itemize}
        \framebreak\relax
        \item 서비스역할 (service model)
        \begin{itemize}[<+->]
            \item 노조는 조합원을 위하여 각종 서비스 제공 $\rightarrow$ 서비스 역할 수행
            \item 마치 피보험자가 보험수수료를 납부하고 보험사고 발생 시 이에 대한 보상을 받는 것과 유사
            \begin{itemize}[<+->]
                \item 노조원이 조합비를 납부하고 고용안정이나 임금인상 등의 서비스 혜택을 받음
            \end{itemize}
            \item 노조의 서비스가 노조원의 욕구를 만족시키면 노조원의 지속적인 지지를 받지만 그렇지 못하면 외면
            \begin{itemize}[<+->]
                \item 노동자와 노조가 당면한 문제를 조합원들의 참여와 활동으로 해결 $\rightarrow$ 노조의 운명을 결정하는 중요한 역할
            \end{itemize}
        \end{itemize}
    \end{enumerate}
\end{frame}
...
\begin{frame}[allowframebreaks]{일반 조합 (general union)}
    \begin{itemize}[<+->]
        ...
        \item 주요 요구조건: 안정된 고용의 확보, 노동시간의 최고한도 규제, 임금의 최저한도 규제 등
        \item 활동: 입법활동을 통한 최저생활 확보
        \begin{itemize}[<+->]
            \item 일반조합의 성격상 내적 통일과 단결이 곤란
        \end{itemize}
        \framebreak\relax
        \item 특징
        \begin{itemize}[<+->]
            \item 미숙련 노동자들을 중심으로 한 조합원들을 결속시키기 위해 중앙집권적 관료제 불가피
            \item 이질적 노동자를 조직대상으로 하기 때문에 조합원간 이해관계의 조정 및 통합이 곤란
            \item 단체교섭기능 약화 가능성
        \end{itemize}
...
\begin{frame}{산업별 조합 (industrial union)}
    \begin{itemize}[<+->]
        ...
        \item 장점
        \begin{itemize}[<+->]
            \item 동일산업을 조직대상으로 하여 거대한 조직, 단결력 강화 가능. 커다란 압력단체 기능
            \item 자본의 집중화의 진행에 대응하여 교섭력 가질 수 있고, 산업내 근로조건의 통일화 유지
        \end{itemize}
        \item 단점
        \begin{itemize}[<+->]
...
\begin{frame}[allowframebreaks]{기업별 조합 (enterprise union)}
    \begin{itemize}[<+->]
        ...
        \begin{itemize}[<+->]
            ...
            \item 기업 내 구성원만을 조직대상으로 하므로 즉, 조합원 수가 적어 뚜렷한 자기기능 발휘 곤란
            \item 다른 노동조합의 형태보다 사용자의 영향력이 상대적으로 커 어용화 될 가능성 높음
        \end{itemize}
...
\begin{frame}[allowframebreaks]{노동조합의 정의}
    ...
    \begin{itemize}[<+->]
        ...
        \begin{itemize}[<+->]
            ...
            \item 설립신고서가 반려되는 경우도 있음. 그럴 경우 `법외 노조'
        \end{itemize}
    \end{itemize}
\end{frame}
