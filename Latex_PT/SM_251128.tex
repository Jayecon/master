...
% TITLE PAGE
%----------------------------------------------------------
\title{Can Innovation City Policy Alleviate Skill Mismatchand its Wage Effects? Evidence from Korean Labor Market}
\subtitle{Lee \& Oh, 2025, \textit{The B. E. Journal of Economic Analysis and Policy}}
...
\begin{frame}
    \frametitle{연구 목표}
    \begin{itemize}[<+->]
        \item  Oh and Lee (2024)에서 정책에 의한 임금상승효과는 전공계열별로 상이함을 발견.
    \end{itemize}
    \begin{enumerate}[<+->]
        \item 정책의 혜택이 전공계열별로 상이한 원인 탐색.
        \item 정책의 혜택이 성별로 상이한지 여부 확인.
        \item 정책은 직무--임금 불일치에 대한 불이익의 크기에 영향을 주는지 여부.
    \end{enumerate}
\end{frame}
...
\begin{frame}
    ...
    \begin{enumerate}[<+->]
        ...
        \item 인문계 졸업생의 초과기술 정도는 감소하는 반면 자연계 졸업생은 유의한 효과가 없음.
        \item 정책은 불일치에 의한 임금불이익 정도를 바꾸지 못함.
        \item 정책은 지거국 자연계 졸업생의 임금불이익 정도를 악화시킴.
        \item 정책의 혜택은 여성이 주로 누림.
    \end{enumerate}
\end{frame}
    ...
    \framebreak%
        \item 이중차분법을 통해 비수도권 대졸자의 직무--기술불일치 해소에 대한 정책의 영향을 추정.% 
            ...
            \begin{itemize}[<+->]
                ...
                \item $D_{p,t}$: t년에 p지역 대졸자가 정책의 영향을 받는지 여부.
            \end{itemize}
    \framebreak%
...
\begin{frame}
    ...
    \begin{itemize}[<+->]
        ...
        \item 자연계 졸업생들이 원하는 양질의 이공계 일자리를 만들어야.
    \end{itemize}
\end{frame}
