    ...
    foreach k of local datalist {
        qui {
            ...
            /*변수조작*/
                ...
                /*변수생성 : 가구유형*/
                    ...
                    replace hhtype = 6 if missing(hhtype) & (nhhmem65 >=1 & nhhmem1864 == 0 & nhhmem17 >= 1) ///
                        | (nhhmem65 == 0 & nhhmem1864 == 1 & nhhmem17 >= 1)
        ...
        /*결과 출력*/
           /*국가명 년도*/
                ...
                local year = year[1]
            if "`k'" == "fr10" {
                di as text "cname,iso2,iso3,year,caret1,caret2,caret3,caret4,caret5,caret6,caret7,caret8,caret9,disabled"
            }
            di as text "`cname',`iso2',`iso3',`year',`caret1',`caret2',`caret3',`caret4',`caret5',`caret6',`caret7',`caret8',`caret9',`numdisabled'"
    }
