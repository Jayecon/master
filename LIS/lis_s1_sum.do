/*호출변수 목록 생성*/
    ...
    local datalist
        /*{{{*/
        /*France*/
            fr10 fr11 fr12 fr13 fr14 fr15 fr16 fr17 fr18 fr19 fr20
        /*Japan*/
            jp10 jp11 jp12 jp13 jp14 jp15 jp16 jp17 jp18 jp19 jp20
        /*South Korea*/
            kr12 kr14 kr16 kr17 kr18 kr19 kr20
        /*Sweden*/
            se10 se11 se12 se13 se14 se15 se16 se17 se18 se19 se20
        /*United Kingdom*/
            uk10 uk11 uk12 uk13 uk14 uk15 uk16 uk17 uk18 uk19 uk20
        /*United States*/
            us10 us11 us12 us13 us14 us15 us16 us17 us18 us19 us20
        /*}}}*/ ;
    #delimit cr
    foreach k of local datalist {
        ...
        /*변수조작*/
            ...
            /*변수생성 : 가구유형*/
                ...
                replace hhtype = 6 if missing(hhtype) & (nhhmem65 >=1 & nhhmem1864 == 0 & nhhmem17 >= 1) | (nhhmem65 == 0 & nhhmem1864 == 1 & nhhmem17 >= 1) // 조손가구 또는 한부모가구 : 정의가 튄다.
