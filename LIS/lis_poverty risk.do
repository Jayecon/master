...
foreach k in $datalist {
    ...
    * 9. 결과 출력
        ...
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `ehpublicq0'; `ehpublicq1'; `ehpublicq2'; `ehpublicq3'; `ehpublicq4'; `ehpublicq5';"*/
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `ehi31q0'; `ehi31q1'; `ehi31q2'; `ehi31q3'; `ehi31q4'; `ehi31q5';"*/
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `ehipubsocq0'; `ehipubsocq1'; `ehipubsocq2'; `ehipubsocq3'; `ehipubsocq4'; `ehipubsocq5';"*/
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `ehxitscq0'; `ehxitscq1'; `ehxitscq2'; `ehxitscq3'; `ehxitscq4'; `ehxitscq5';"*/
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `eminq0'; `eminq1'; `eminq2'; `eminq3'; `eminq4'; `eminq5';"*/
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `ehitotalq0'; `ehitotalq1'; `ehitotalq2'; `ehitotalq3'; `ehitotalq4'; `ehitotalq5';"*/
        /*di as text "`cname'; `iso2'; `iso3'; `year'; `edhiq0'; `edhiq1'; `edhiq2'; `edhiq3'; `edhiq4'; `edhiq5';"*/
}
