/*호출변수 목록 생성*/
    ...
    /*Scalars{{{*/
        ...
        /*}}}*/
        /*care scalars{{{*/
            scalar frcaret1 = .7941418707370758
            scalar frcaret2 = .7130834847688675
            scalar frcaret3 = .4611448287963867
            scalar frcaret4 = .4550919115543365
            scalar frcaret5 = .496345329284668
            scalar frcaret6 = .6221087947487831
            scalar frcaret7 = .6178294807672501
            scalar frcaret8 = .519170118495822
            scalar frcaret9 = .6029595419764519
            scalar jpcaret1 = .6437005400657654
            scalar jpcaret2 = .4972889065742493
            scalar jpcaret3 = .0066880993545055
            scalar jpcaret4 = .0059683538973331
            scalar jpcaret5 = .1459538355469704
            scalar jpcaret6 = .0680685915052891
            scalar jpcaret7 = .1422820642590523
            scalar jpcaret8 = .112726779282093
            scalar jpcaret9 = .1844398185610771
            scalar krcaret1 = .556290383140246
            scalar krcaret2 = .4535515209039052
            scalar krcaret3 = .0433342730005582
            scalar krcaret4 = .0295297553141912
            scalar krcaret5 = .0762130711227655
            scalar krcaret6 = .1044457256793976
            scalar krcaret7 = .1610824689269066
            scalar krcaret8 = .0744387793044249
            scalar krcaret9 = .1891634662946065
            scalar secaret1 = .5718995928764343
            scalar secaret2 = .4110688477754593
            scalar secaret3 = 0
            scalar secaret4 = 0
            scalar secaret5 = .0212539095431566
            scalar secaret6 = .1496565766632557
            scalar secaret7 = .1931678116321564
            scalar secaret8 = .0334045428782701
            scalar secaret9 = .0934233846142888
            scalar ukcaret1 = .6878297507762909
            scalar ukcaret2 = .5346137404441833
            scalar ukcaret3 = .2100686281919479
            scalar ukcaret4 = .091829140484333
            scalar ukcaret5 = .1361406914889813
            scalar ukcaret6 = .2885717630386352
            scalar ukcaret7 = .233658792078495
            scalar ukcaret8 = .1354095123708248
            scalar ukcaret9 = .2764419257640839
            scalar uscaret1 = .6442739486694335
            scalar uscaret2 = .475336503982544
            scalar uscaret3 = .1762365162372589
            scalar uscaret4 = .0905464462935925
            scalar uscaret5 = .1493926033377647
            scalar uscaret6 = .5989186584949493
            scalar uscaret7 = .4741199791431427
            scalar uscaret8 = .3081548511981964
            scalar uscaret9 = .4447019547224045
        /*}}}*/
        /*rent scalars{{{*/
