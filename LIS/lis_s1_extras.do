        ...
        /*변수조작*/
            ...
            /*입력받은 수치를 국가별 성별 연령별 집단에게 부여{{{*/
                ...
                /*{{{*/
                    ...
                    replace health = jpmh1624 if inrange(age , 16 , 24)  & sex == 1
                    replace health = jpfh1624 if inrange(age , 16 , 24)  & sex == 2
                    replace health = jpmh2534 if inrange(age , 25 , 34)  & sex == 1
                    replace health = jpfh2534 if inrange(age , 25 , 34)  & sex == 2
                    replace health = jpmh3544 if inrange(age , 35 , 44)  & sex == 1
                    replace health = jpfh3544 if inrange(age , 35 , 44)  & sex == 2
                    replace health = jpmh4554 if inrange(age , 45 , 54)  & sex == 1
                    replace health = jpfh4554 if inrange(age , 45 , 54)  & sex == 2
                    replace health = jpmh5564 if inrange(age , 55 , 64)  & sex == 1
                    replace health = jpfh5564 if inrange(age , 55 , 64)  & sex == 2
            ...
            /*변수 생성 : 모두실업*/
                ...
                gen temp1  = ln(umemp)  if !missing(unemp)
                egen temp2 = total(temp1)
                gen aunemp = exp(temp2) if !missing(unemp)
            /*변수 생성 : 실업있음*/
                capture drop temp1 temp2 temp3
                gen temp1  = 1 - unemp  if !missing(unemp)
                gen temp2  = ln(temp1)  if !missing(unemp)
                egen temp3 = total(temp2)
