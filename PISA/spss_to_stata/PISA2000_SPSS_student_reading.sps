...
DATA LIST file="e:/works/pisa/pisa2000/intstud_read_v3.txt"
/ COUNTRY      2 - 4 (a)
SCHOOLID     5 - 9 (a)
STIDSTD     10 - 14 (a)
SUBNATIO    16 - 17 (a)
...
cntrfac          "Adjustment factor to compute Senate weights for Reading"
...
read_waf         "AUT weight adjustment factor" .
EXECUTE.
...
FORMATS wleread to pv5read3 (f7.2).
FORMATS w_fstuwt  w_fstr1 to w_fstr80 read_waf (f9.4).
*FORMATS w_mfac w_sfac (f9.7).
FORMATS cntrfac (f9.7).
execute.
...
MISSING VALUES 
 ...
 /   wleread to pv5read3 (9997)
 /   ST01Q02 ("97","99")
 /   ST01Q03 ST09Q01 ST11Q01 ST40Q01 ("9997","9999").

EXECUTE.

    SAVE TRANSLATE OUTFILE= 'E:\works\pisa\stata\p00_reading.dta'
          /TYPE=STATA
          /VERSION=13
          /EDITION=SE
          /MAP
