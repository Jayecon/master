...
use `path'p18_school.dta , clear 
	rename _all, low
/*Macro List for School{{{*/
mvdecode sc001q01ta , mv( 99=. / 98=. / 97=. / 95=. )
mvdecode stratio    , mv( 99999999=. / 99999998=. / 99999997=. / 99999995=. )
mvdecode proatce    , mv( 99999999=. / 99999998=. / 99999997=. / 99999995=. )
mvdecode proat5ab   , mv( 99999999=. / 99999998=. / 99999997=. / 99999995=. )
/*}}}*/
	isid `schidlist'
...
mvdecode st005q01ta , mv( 99=. / 98=. / 97=. / 95=. ) 
mvdecode st006q01ta , mv( 9=. / 8=. / 7=. ) 
mvdecode st006q02ta , mv( 9=. / 8=. / 7=. ) 
mvdecode st006q03ta , mv( 9=. / 8=. / 7=. ) 
mvdecode st006q04ta , mv( 9=. / 8=. / 7=. )  
mvdecode st007q01ta , mv( 99=. / 98=. / 97=. / 95=. )
mvdecode st008q01ta , mv( 9=. / 8=. / 7=. ) 
mvdecode st008q02ta , mv( 9=. / 8=. / 7=. ) 
mvdecode st008q03ta , mv( 9=. / 8=. / 7=. ) 
mvdecode st008q04ta , mv( 9=. / 8=. / 7=. )  
mvdecode st019aq01t , mv( 9=. / 8=. / 7=. ) 
mvdecode st019bq01t , mv( 9=. / 8=. / 7=. ) 
mvdecode st019cq01t , mv( 9=. / 8=. / 7=. )  
mvdecode st011q01ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q02ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q03ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q04ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q05ta , mv( 9=. / 8=. / 7=. / 5=. )  
mvdecode st011q06ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q07ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q08ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q09ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q10ta , mv( 9=. / 8=. / 7=. / 5=. )  
mvdecode st011q11ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q12ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st011q16na , mv( 9=. / 8=. / 7=. / 5=. )  
mvdecode st012q01ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st012q02ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st012q03ta , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st012q05na , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st012q06na , mv( 9=. / 8=. / 7=. / 5=. )  
mvdecode st012q07na , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st012q08na , mv( 9=. / 8=. / 7=. / 5=. ) 
mvdecode st012q09na , mv( 9=. / 8=. / 7=. / 5=. )  
mvdecode st013q01ta , mv( 99=. / 98=. / 97=. / 95=. )
mvdecode bfmj2      , mv( 999999=. / 999998=. / 999997=. / 999995=. )
mvdecode bmmj1      , mv( 999999=. / 999998=. / 999997=. / 999995=. )
mvdecode misced     , mv( 99=. / 98=. / 97=. / 95=. )
mvdecode fisced     , mv( 99=. / 98=. / 97=. / 95=. )
mvdecode hisced     , mv( 99=. / 98=. / 97=. / 95=. )
mvdecode hisei      , mv( 999999=. / 999998=. / 999997=. / 999995=. )
mvdecode escs       , mv( 9999999=. / 9999998=. / 9999997=. / 9999995=. )
/*}}}*/
	isid `stuidlist'
