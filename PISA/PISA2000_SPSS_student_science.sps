...
DATA LIST file="e:\works\pisa\pisa2000\intstud_scie_v3.txt" 
/ COUNTRY      2 - 4 (a)
SCHOOLID     5 - 9 (a)
STIDSTD     10 - 14 (a)
SUBNATIO    16 - 17 (a)
...
wlescie          "Warm estimate in science"
wlerr_s          "Estimation Error of WLESCIE"
...
cntsfac          "Adjustment factor to compute Senate weights for Science"
...
scie_waf         "AUT weight adjustment factor" .
...
FORMATS wleread to pv5scie (f7.2).
FORMATS w_fstuwt  w_fstr1 to w_fstr80 scie_waf (f9.4).
FORMATS cntsfac (f9.7).
execute.
...
MISSING VALUES 
 ...
 /   wleread to pv5scie (9997)
 /   ST01Q02 ("97","99")
 /   ST01Q03 ST09Q01 ST11Q01 ST40Q01 ("9997","9999").

EXECUTE.

    SAVE TRANSLATE OUTFILE= 'E:\works\pisa\stata\p00_science.txt'
          /TYPE=STATA
          /VERSION=13
          /EDITION=SE
          /MAP
