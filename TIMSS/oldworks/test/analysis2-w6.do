...
log using "`path_input'analysis2-w6.log", replace text;
...
preserve;
keep if wave==6;
bys idcntry: sum bsmmat01 bsssci01;
restore;

tab cntry wave;


foreach var of local c6list {;
...
mi impute chained (regress) bsmmat01 /* bsssci01 */ cedu cbok (logit) dsex, add(20) force;
