  ...
  use goms_master , clear
    ...
    /*변수 생성 : 고등학교계열 {{{*/
      ...
      egen f998 = rowlast(temp??) 
        label define F998 1 "기타(특성화등)" 2 "일반계(문과)" 3 "일반계(이과)" 4 "특목고(예체능)" 5 "강남3구" 6 "자율고" 7 "특목고(외과국)" 
    ...
    /*변수 생성 : main(주된캠퍼스) {{{*/
      gen main =.
        ...
        replace main = 1 if inlist(branch , 1 ) & uniname == "가천대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "가톨릭대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "강원대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "건국대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "경북대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "경상대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "경희대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "고려대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "광운대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "광주과학기술원"
        replace main = 1 if inlist(branch , 1 ) & uniname == "국민대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "단국대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "동국대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "명지대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "부경대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "부산대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "서강대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "서울대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "서울시립대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "성균관대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "세종대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "숙명여자대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "순천향대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "숭실대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "아주대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "연세대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "영남대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "울산과학기술원"
        replace main = 1 if inlist(branch , 1 ) & uniname == "울산대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "원광대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "이화여자대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "인제대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "인천대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "인하대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "전남대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "전북대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "제주대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "조선대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "중앙대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "충남대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "충북대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "포항공과대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "한국과학기술원"
        replace main = 1 if inlist(branch , 1 ) & uniname == "한국교원대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "한국외국어대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "한국해양대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "한림대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "한양대학교"
        replace main = 1 if inlist(branch , 1 ) & uniname == "홍익대학교"
      /*}}}*/
    /*변수 생성 : 대학등급 {{{*/
      gen score5 = .
