...
clear
    ...
    local varlist00 ///
        ...
        h001 h002 h020 h040 h060 i050 l001 l003 m001 m002                           ///
    ...
    /*loop*/
        forvalue x = 7/19 {
            ...
            /*list of year varing variables {{{*/
                ...
                /*어학연수횟수*/
                    if (`x' == 9) {
                        local varlist `varlist' i004 i009 i014
                    }
                    else {
                ...
                /*취업시험*/
                    if (`x' == 7) {
                        local varlist `varlist' n001 n010 n024 n038 n045 
                    }
                    else {
                        local varlist `varlist' n083 n096 n113 n130
                    }
            /*}}}*/
