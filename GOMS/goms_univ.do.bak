...
set more off
set maxvar 30000
    /*  gen univ data with relate vars {{{*/
        tempfile tfile
        forvalue x = 7/19 {
    ...
    /*gen original of vars*/
        gen orifound    = found
        gen oribranch   = branch
        gen oriuniname  = uniname
        gen oriprovince = province
        gen oriarea     = area
        label var orifound     "Original of found"
        label var oribranch    "Original of branch"
        label var oriuniname   "Original of uniname"
        label var oriprovince  "Original of province"
        label var oriarea      "Original of area"
    /*cleaning : found{{{*/
    ...
    /*gen unifound : found clean by univ. {{{*/
        gen unifound = .
        label var unifound "found(cleaned)"
    ...
    /*gen unibranch : branch clean by univ. {{{*/
        ...
        capture drop br_*
        gen unibranch = .
        label var unibranch "branch(cleaned)"
    ...
    /* gen uniprovince : province clean by univ. {{{*/
        ...
        capture drop pr_*
        gen uniprovince = .
        label var uniprovince "province(cleaned)"
    ...
    replace uniprovince = . if missing(uniarea)
