...
foreach k of local grplist {
	...
	eopcal score`j' [aw=wgt] if f001 == `i' , env(`k') `rri' b(100)
	matrix `temp1'[1,1] = 2			 
	matrix `temp1'[1,2] = 3          
	matrix `temp1'[1,3] = `i'        
...
foreach k of local grplist {
	...
	eopcal score`j' [aw=wgt] if f001 == `i' & sex == `m' , env(`k') `rri' b(100)
	matrix `temp1'[1,1] = 2			 
	matrix `temp1'[1,2] = 3          
	matrix `temp1'[1,3] = `i'        
	matrix `temp1'[1,4] = `grouptype'        
...
foreach k of local grplist {
	...
	eopcal score`j' [aw=wgt] if f001 == `i' & f013 == `l' , env(`k') `rri' b(100)
	matrix `temp1'[1,1] = 2			 
	matrix `temp1'[1,2] = 3          
	matrix `temp1'[1,3] = `i'        
	matrix `temp1'[1,4] = `grouptype'        
...
save goms_rri_score5.dta , replace
