...
use `path'goms/goms_eq_raw , clear
    ...
    /*자료 변환 : 모든 변수 labeling {{{*/
        ...
        /*eq 2nd rv */
            local temp : var label f03619
            label var f036  "`temp'"
            label copy G191F036 F036
            label value f036 F036
            local temp : var label f03719
            label var f037  "`temp'"
            label copy G191F037 F037
            label value f037 F037
            local temp : var label f03819
            label var f038  "`temp'"
            label copy G191F038 F038
            label value f038 F038
            local temp : var label f03919
            label var f039  "`temp'"
            label copy G191F039 F039
            label value f039 F039
            local temp : var label f04019
            label var f040  "`temp'"
            label copy G191F040 F040
            label value f040 F040
            local temp : var label f04119
            label var f041  "`temp'"
            label copy G191F041 F041
            label value f041 F041
            local temp : var label l00119
            label var l001  "`temp'"
            label copy G191L001 L001
            label value l001 L001
            local temp : var label l00319
            label var l003  "`temp'"
            local temp : var label l01619
            label var l016  "`temp'"
            local temp : var label l04219
            label var l042  "`temp'"
            local temp : var label l06819
            label var l068  "`temp'"
            local temp : var label m00119
            label var m001  "`temp'"
            label copy G191M001 M001
        ...
        local temp : var label f01019
        label var f010  "`temp'"
        local temp : var label f01119
        label var f011  "`temp'"
        local temp : var label f01219
        label var f012  "`temp'"
    /*}}}*/
    /*변수 교정 : 년도별 응답 불일치 {{{*/
