...
use `path'goms/goms_eq_raw , clear
    /* gen vars to convert data from wide to long{{{*/
        /*num vars*/
            local numvarlist ///
                ...
                h001 h002 h006 h007 h008 h009 h026 h027 h028 h029 h046 h047 h048 h049 ///
    ...
    /*recoding variables to fix year varing value problems{{{*/
        ...
        if ("`x'" == "14" ){
            recode f009 (4=6) (5=7) (6=8) (7=4) (8=10)
        }
    /*}}}*/
    /*gen a999 a998 {{{*/
        capture drop a999
    ...
    /*통계청 지역벌 인구조사*/
        ...
        /*drop _merge*/
    order _all , alpha
    order pid year branch branchdtl distance latitude longitude major medtyp school schooldtl found founddate foundname hsname hsnamec innoarea birthy majorcat province provincecl area areadtl sex age graduy gradum address , first
