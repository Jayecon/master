...
foreach i of varlist goi-bj1e {
	...
	replace `i'_f = . if inlist(year, 1995, 1999, 2003, 2007, 2011, 2015, 2019)
}
...
keep if inlist(year, 1995, 1999, 2003, 2007, 2011, 2015, 2019)
