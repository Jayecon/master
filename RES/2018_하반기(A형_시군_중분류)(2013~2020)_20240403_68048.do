...
import delimited "`path'2018_하반기(A형_시군_중분류)(2013~2020)_20240403_68048.csv", delimiter(",") numericcols(5, 17, 18, 19, 28, 37, 47) stringcols(1, 24, 44) varnames(nonames) rowrange(2)
        ...
        label define v6CD 0"안받았음(무학)" 1"초등학교" 2"중학교" 3"고등학교" 4"전문대" 5"대학교" 6"대학원(석사)" 7"대학원(박사)"
