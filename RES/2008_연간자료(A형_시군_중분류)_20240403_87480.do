...
import delimited "`path'2008_연간자료(A형_시군_중분류)_20240403_87480.csv", delimiter(",") numericcols(47) stringcols(4, 15, 16, 17, 23, 36, 41, 42) varnames(nonames) rowrange(2)
        ...
        label define v34CD 1"있었음" 2"없었음"
