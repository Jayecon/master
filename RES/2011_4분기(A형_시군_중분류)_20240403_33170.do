...
import delimited "`path'2011_4분기(A형_시군_중분류)_20240403_33170.csv", delimiter(",") numericcols(45) stringcols(1, 5, 17, 18, 19, 25, 30, 35, 36, 42) varnames(nonames) rowrange(2)
        ...
        label variable v29 "19.전직유무"
        label variable v30 "19.1.이직시기(1년 미만)"
        label variable v31 "20.직장을그만둔이유"
        label variable v32 "21.산업코드"
        label variable v33 "22.직업코드"
        label variable v34 "23.종사상지위"
        label variable v35 "24.직장시작 년,월"
        label variable v36 "25.3개월 평균임금"
        label variable v37 "26.근로기간 계약여부"
        label variable v38 "26-1.근로기간"
        label variable v39 "27.교육훈련 참여여부"
        label variable v40 "27-1.직업교육훈련과 관련여부"
        label variable v41 "27-1-1_주된교육훈련"
        label variable v42 "27-1-2_주된교육훈련"
        ...
        label define v7CD 1"인문계열" 2"예술ㆍ체육계열" 3"상농공수산계열 등"
        ...
        label define v41CD 11"직장연수, 기관주관 직업훈련(영농교육 포함)" 12"TV, 라디오, 인터넷 등을 통한 자기주도 학습" 13"한원수강" 14"교양강좌(대학평생교육원, 복지관, 시민회관)" 15"기타"
