...
import delimited "`path'2011_1분기(A형_시군_중분류)_20240403_31992.csv", delimiter(",") numericcols(40) stringcols(1, 5, 16, 17, 18, 24, 29, 34, 35) varnames(nonames) rowrange(2)
        ...
        label variable v28 "20.전직유무"
        label variable v29 "20.1.이직시기"
        label variable v30 "21.직장을그만둔이유"
