...
import delimited "`path'2012_1분기(A형_시군_중분류)_20240403_31992.csv", delimiter(",") numericcols(41) stringcols(1, 5, 17, 18, 19, 25, 30, 35, 36) varnames(nonames) rowrange(2)
        ...
        label variable v20 "13.즉시취업 가능여부(실업)"
        ...
        label variable v29 "20.전직유무"
        label variable v30 "20.1.이직시기"
        label variable v31 "21.직장을그만둔이유"
        label variable v32 "22.산업코드"
        label variable v33 "23.직업코드"
        label variable v34 "24.종사상지위"
        label variable v35 "25.직장시작년월"
        label variable v36 "26.3개월 평균임금"
        label variable v37 "27.근로기간 계약여부"
        label variable v38 "27-1.근로기간"
        label variable v39 "사업체소재지코드"
        label variable v40 "교육정도컨버전"
        label variable v41 "시군가중치"
        label variable v42 "경제활동상태구분"
