...
import delimited "`path'2011_3분기(A형_시군_중분류)_20240403_78624.csv", delimiter(",") numericcols(47) stringcols(1, 5, 17, 18, 19, 25, 35, 40, 41, 42) varnames(nonames) rowrange(2)
        ...
        label variable v14 "10.4주내 구직활동 여부"
        ...
        label variable v20 "13.취업가능성(실업)"
