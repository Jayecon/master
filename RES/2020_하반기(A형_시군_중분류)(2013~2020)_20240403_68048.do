...
import delimited "`path'2020_하반기(A형_시군_중분류)(2013~2020)_20240403_68048.csv", delimiter(",") numericcols(5, 17, 18, 19, 28, 37, 47) stringcols(1, 24, 44) varnames(nonames) rowrange(2)
        ...
        label define v8CD 1"교육" 2"예술" 3"인문학" 4"사회과학, 언론·정보학" 5"경영, 행정·법학" 6"자연과학, 수학·통계학" 7"정보통신기술" 8"공학, 제조·건설" 9"농림어업·수의학" 10"보건" 11"복지" 12"서비스"
        label define v9CD 1"졸업" 2"재학" 3"중퇴" 4"휴학" 5"수료"
        ...
        label define v30CD 1"없음" 2"1번" 3"2번" 4"3번" 5"4번이상"
        ...
        label define v46CD 1"취업자" 2"실업자" 3"비경제활동인구" 4"제외자"
