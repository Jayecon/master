...
import delimited "`path'2012_2분기(A형_시군_중분류)_20240403_10548.csv", delimiter(",") numericcols(40) stringcols(1, 5, 16, 17, 18, 24, 29, 34, 35) varnames(nonames) rowrange(2)

        label variable v1 "조사년,분기"
        label variable v2 "행정구역"
        label variable v3 "2.가구주와의 관계"
        label variable v4 "3.성별"
        ...
        label variable v20 "14-1.구직 주요경로1"
        label variable v21 "14-1.구직 주요경로2"
        label variable v22 "14-2.구직방법1"
        label variable v23 "14-2.구직방법2"
        ...
        label variable v28 "19.전직유무"
        label variable v29 "19-1.이직시기"
        label variable v30 "20.직장을그만둔이유"
        label variable v31 "22.산업코드"
        label variable v32 "23.직업코드"
        label variable v33 "24.종사상지위"
        label variable v34 "25.직장시작년월"
        label variable v35 "26.3개월 평균임금"
        label variable v36 "27.근로기간 계약여부"
        label variable v37 "27-1.근로기간"
        label variable v38 "사업체소재지코드"
        label variable v39 "교육정도컨버전"
        label variable v40 "시군가중치"
        label variable v41 "경제활동상태"
        ...
        label define v9CD 1"미혼" 2"배우자 있음" 3"사별" 4"이혼"
