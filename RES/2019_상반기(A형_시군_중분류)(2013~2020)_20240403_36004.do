...
import delimited "`path'2019_상반기(A형_시군_중분류)(2013~2020)_20240403_36004.csv", delimiter(",") numericcols(5, 18, 19, 20, 29, 36, 46) stringcols(1, 26, 43) varnames(nonames) rowrange(2)
        ...
        label define v28CD 1"1개월 미만" 2"1개월~6개월 미만" 3"6개월~1년 미만" 4"1년" 5"1년 초과~2년" 6"2년 초과~3년" 7"3년 초과"
