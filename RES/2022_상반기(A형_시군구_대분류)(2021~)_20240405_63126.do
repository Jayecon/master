...
import delimited "`path'2022_상반기(A형_시군구_대분류)(2021~)_20240405_63126.csv", delimiter(",") numericcols(5, 18, 19, 20, 30, 46) stringcols(1, 27, 37, 44) varnames(nonames) rowrange(2)
