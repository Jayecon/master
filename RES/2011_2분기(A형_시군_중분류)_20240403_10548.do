...
import delimited "`path'2011_2분기(A형_시군_중분류)_20240403_10548.csv", delimiter(",") numericcols(40) stringcols(1, 5, 16, 17, 18, 24, 29, 34, 35) varnames(nonames) rowrange(2)
        ...
        label variable v29 "19.1.이직시기(1년 미만)"
