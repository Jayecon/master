...
import delimited "`path'2019_하반기(A형_시군_중분류)(2013~2020)_20240403_68048.csv", delimiter(",") numericcols(5, 17, 18, 19, 28, 37, 47) stringcols(1, 24, 44) varnames(nonames) rowrange(2)
